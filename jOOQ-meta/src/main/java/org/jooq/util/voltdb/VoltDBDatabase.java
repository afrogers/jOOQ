...
public class VoltDBDatabase extends AbstractDatabase{
    ...
    protected DSLContext create0() {
        return DSL.using(getConnection(), SQLDialect.VOLTDB);
    }
    ...
    protected List<SequenceDefinition> getSequences0() throws SQLException {
        return Collections.<SequenceDefinition>emptyList();
    }
    ...
    protected List<RoutineDefinition> getRoutines0() throws SQLException {
        List<RoutineDefinition> definitions = new ArrayList<RoutineDefinition>();
        DatabaseMetaData dbmd = getConnection().getMetaData();
        Result<Record> procedures = create().fetch(
            dbmd.getProcedures(null, null, null),
            SQLDataType.VARCHAR,
            SQLDataType.VARCHAR,
            SQLDataType.VARCHAR,
            SQLDataType.VARCHAR,
        ...
        for (String name: procedures.getValues(2, String.class)) {
            definitions.add(new VoltDBRoutineDefinition(getSchema(""), name, null));
        }
